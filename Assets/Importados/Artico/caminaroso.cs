...
public class caminaroso : MonoBehaviour
{
    public float moveSpeed = 2.0f; // Velocidad de movimiento del oso
    public float semiMajorAxis = 5.0f; // Semieje mayor de la elipse en el eje X
    public float semiMinorAxis = 2.0f; // Semieje menor de la elipse en el eje Z
    public float rotationSpeed = 30.0f; // Velocidad de rotación del oso
